...
@Data
@TableName(value = "exclusive_confirm_data_repayment")
public class ExclusiveConfirmDataRepayment implements Serializable {
    /**
     * id
     */
    @TableId(value = "exclusive_confirm_data_repayment_id", type = IdType.INPUT)
    private Long exclusiveConfirmDataRepaymentId;
